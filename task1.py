...
#print('The maximum temperature today in', location, 'is', weatherData['main']['temp_max'], 'celsius')
#print('The minimum temperature today in', location, 'is', weatherData['main']['temp_min'], 'celsius')
